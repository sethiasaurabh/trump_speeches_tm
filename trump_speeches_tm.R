...
## Combining words that should stay together.for example, combine "inner", "city" as "inner-city" so
# you can analyze them together
...
wordcloud(names(freq), freq, max.words=120, rot.per=0.2, colors=dark2)    
